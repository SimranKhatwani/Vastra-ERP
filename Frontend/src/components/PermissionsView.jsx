...
export const PermissionsView = ({
  ...
  const modulesRegistry = [
    ...
    { id: "summary-dashboard", name: "Summary Dashboard", category: "Core Operations", icon: Layers, desc: "Consolidated Operations, Salesman follow-up, Customer service & Management analytics" },
