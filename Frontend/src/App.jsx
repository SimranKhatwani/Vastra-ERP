...
const normalizeInvoice = (b) => {
  ...
  return {
    ...
    isGstApplied: b.isGstApplied !== undefined ? b.isGstApplied : Boolean(b.taxDetails?.isApplied),
    gstRate: b.gstRate || b.taxDetails?.gstRate || 0,
    cgstRate: b.cgstRate || b.taxDetails?.cgstRate || 0,
    sgstRate: b.sgstRate || b.taxDetails?.sgstRate || 0,
    igstRate: b.igstRate || b.taxDetails?.igstRate || 0,
    taxableAmount: b.taxableAmount || b.taxDetails?.taxableAmount || 0,
    cgstAmount: b.cgstAmount || b.taxDetails?.cgstAmount || 0,
    sgstAmount: b.sgstAmount || b.taxDetails?.sgstAmount || 0,
    igstAmount: b.igstAmount || b.taxDetails?.igstAmount || 0,
    totalTax: b.totalTax || b.taxDetails?.totalTax || b.taxAmount || 0,
    taxDetails: b.taxDetails || undefined,
    taxBreakdown: b.taxBreakdown || undefined,
  ...
  const handleAddInvoice = React.useCallback(async (inv) => {
    ...
    try {
      ...
      const billingPayload = {
        ...
        isGstApplied: Boolean(inv.isGstApplied),
        gstRate: Number(inv.gstRate || 0),
        cgstRate: Number(inv.cgstRate || 0),
        sgstRate: Number(inv.sgstRate || 0),
        igstRate: Number(inv.igstRate || 0),
        ...
        totalTax: Number(inv.totalTax || inv.gstTotal || 0),
        taxDetails: inv.taxDetails || null,
        taxBreakdown: inv.taxBreakdown || null
      };
